...
function adminDeveloper() {
  return `<div class="sketch-box" style="border-color:var(--red)">
    ...
    <p class="text-muted mb-1" style="font-size:0.82rem">Search a card, pick a target (yourself or any username), then hit Give. Check your collection to confirm.</p>
    <div style="display:flex;gap:0.6rem;margin-bottom:0.5rem;flex-wrap:wrap">
      <input class="input-box" id="dev-card-search" placeholder="Search cards (name or type)..." style="flex:2;min-width:160px"
      ...
      <button class="btn btn-primary" onclick="devCardSearch()">Search</button>
    </div>
