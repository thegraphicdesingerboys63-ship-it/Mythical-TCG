...
const CONQUEST_CHAPTERS = [
  {
    ...
    stages:[
      { id:1, name:'First Blood', reward:40,  isBoss:false, voiceover:'/stage1.mp4', voiceoverDuration:53.629, panels:[
...
function _cqStartPanel(idx) {
  ...
  if (window._cqAudio && window._cqVoTimings) {
    ...
    if (idx === 0 && window._cqAudio.paused) window._cqAudio.play().catch(() => {});
    return;
  }
