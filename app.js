...
function viewPvpBattle() {
  ...
  return `<div class="page-title">
    <h2>PvP</h2>
    <span class="text-muted" style="font-size:0.9rem">${modeLabel} · vs <strong>${opp}</strong></span>
  </div>
  <div class="battle-arena">
    <div style="display:flex;justify-content:space-between;align-items:center;padding:0.3rem 0">
      <span style="font-family:var(--font-brush);font-size:1.2rem">${opp}</span>
      <div style="display:flex;align-items:center;gap:0.75rem">
        <span class="text-muted" style="font-size:0.85rem">${b.aiCards.filter(c=>c.current_hp>0).length} remaining</span>
        ${b.playerTurn && !b.finished
    ...
    <div class="battle-field">
      <div class="battle-active-slot"><div class="battle-label">${opp}</div>${renderCard(aa)}</div>
      <div class="vs-divider">VS</div>
      <div class="battle-active-slot"><div class="battle-label">You</div>${renderCard(pa)}</div>
    </div>
    ...
    <div class="battle-controls">
      ${b.playerTurn && !b.finished
        ? `<button class="btn btn-primary" id="btn-attack" onclick="pvpAction('attack')">Attack: ${pa.ability_name} (${pa.ability_power} pwr)</button>
...
function viewProfile() {
  ...
  <div class="profile-layout">
    <div class="profile-card-col">
      <div class="profile-avatar" style="background:${p.avatar_color||'#c0392b'}">${p.username[0].toUpperCase()}</div>
...
function adminStaffChat() {
  ...
  const chatHtml = msgs.length
    ? msgs.map(m => `<div class="staff-msg">
        <span class="staff-msg-avatar" style="background:${m.avatar_color||'#c0392b'}">${m.username[0].toUpperCase()}</span>
...
function adminDeveloper() {
  return `<div class="sketch-box" style="border-color:var(--red)">
    ...
    <div class="grid-3 gap-1">
      ...
      <div class="form-group"><label>Set Name</label><input id="promo-set" class="input-box" placeholder="Promo Series"></div>
