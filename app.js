  ...
  <div class="battle-arena">
    ...
    ${(() => {
      ...
      const comboHtml = combo >= 2
        ...
        : '';
      return comboHtml ? `<div class="orb-row">${comboHtml}</div>` : '';
    })()}
    ...
    <div class="battle-controls">
      ${b.playerTurn && !b.finished ? `
        ...
        <button class="btn btn-primary${(pa.orbs||0) >= clientOrbCost(pa) ? '' : ' orb-locked'}" id="btn-ability" onclick="battleAction('ability')" ${(pa.orbs||0) >= clientOrbCost(pa) ? '' : 'disabled'}>
  ...
  <div class="battle-arena battle-arena-bg${b.playerTurn?' battle-turn-glow':''}">
    ...
    <div class="battle-controls">
      ${b.playerTurn && !b.finished ? `
        ...
        <button class="btn btn-primary${(pa.orbs||0) >= clientOrbCost(pa) ? '' : ' orb-locked'}" id="btn-ability" onclick="battleAbility()" ${(pa.orbs||0) >= clientOrbCost(pa) ? '' : 'disabled'}>
          ✦ ${pa.ability_name} <span class="orb-cost-badge">${clientOrbCost(pa)} orbs</span>
        </button>
