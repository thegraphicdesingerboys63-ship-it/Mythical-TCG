...
async function initDB() {
  ...
  // Seed achievements
  const achDefs = [
    ['first_win',      'First Victory',        'Win your first battle',               '⚔️', 'general',  'win_battle',   1,   50],
    ['win_10',         'Battle Hardened',       'Win 10 battles',                      '🏆', 'battles',  'win_battle',  10,  100],
    ['win_50',         'Veteran',               'Win 50 battles',                      '⚔️', 'battles',  'win_battle',  50,  250],
    ['win_100',        'Champion',              'Win 100 battles',                     '👑', 'battles',  'win_battle', 100,  500],
    ['pvp_win_1',      'Online Debut',          'Win your first PvP battle',           '🎮', 'pvp',      'win_pvp',      1,  100],
    ['pvp_win_10',     'PvP Warrior',           'Win 10 PvP battles',                  '🏆', 'pvp',      'win_pvp',     10,  300],
    ['conquest_1',     'Adventurer',            'Complete your first conquest stage',  '🗺️', 'conquest', 'win_conquest', 1,   75],
    ['conquest_10',    'Conquerer',             'Complete 10 conquest stages',         '⚔️', 'conquest', 'win_conquest',10,  200],
    ['open_1_pack',    'First Pack',            'Open your first card pack',           '📦', 'collection','open_pack',   1,   25],
    ['open_10_packs',  'Pack Addict',           'Open 10 card packs',                  '📦', 'collection','open_pack',  10,  150],
    ['first_ability',  'Ability Unleashed',     'Use an ability for the first time',   '✦',  'battle',   'use_ability',  1,   25],
    ['ability_50',     'Ability Master',        'Use abilities 50 times',              '✦',  'battle',   'use_ability', 50,  200],
    ['energy_25',      'Energy Flow',           'Attach energy 25 times',              '⚡', 'battle',   'attach_energy',25,  75],
    ['craft_legendary','Master Forger',         'Craft a Legendary card',              '🔨', 'crafting', 'craft_legendary',1, 300],
    ['gift_card',      'Generous Spirit',       'Gift a card to a friend',             '🎁', 'social',   'gift_card',    1,   50],
    ['gift_5',         'Card Philanthropist',   'Gift 5 cards to friends',             '🎁', 'social',   'gift_card',    5,  200],
    ['reach_silver',   'Silver Ranked',         'Reach Silver rank in PvP',            '🥈', 'pvp',      'reach_rank',1200, 150],
    ['reach_gold',     'Gold Ranked',           'Reach Gold rank in PvP',              '🥇', 'pvp',      'reach_rank',1400, 300],
    ['reach_master',   'Master Ranked',         'Reach Master rank in PvP',            '💎', 'pvp',      'reach_rank',2000, 500],
    ['play_100',       'Battle Legend',         'Play 100 total battles',              '🔥', 'battles',  'play_battle', 100, 400],
  ];
  for (const [slug, name, desc, icon, cat, trigger_type, trigger_value, reward_coins] of achDefs) {
    await query(
      `INSERT INTO achievements (slug,name,description,icon,category,trigger_type,trigger_value,reward_coins) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) ON CONFLICT (slug) DO NOTHING`,
      [slug, name, desc, icon, cat, trigger_type, trigger_value, reward_coins]
    );
  }
