  ...
  try {
    ...
    if (battle.isConquest) {
      if (won) {
        ...
        // Piece system: each stage drops the corresponding piece (stage 1→piece 1, etc.)
        await query(
        ...
        battle.ratingResult = { conquestWin: true, coinsEarned: reward, bossCardUnlocked, pieceDropped: stId };
      } else {
